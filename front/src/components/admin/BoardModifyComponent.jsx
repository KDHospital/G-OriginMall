...
const BoardModifyComponent = ({ bno, onMoveToRead }) => {
  ...
  if (fetching) return <div className="py-24 text-center text-gray-400">데이터를 불러오는 중입니다...</div>;
    ...
    <div className="space-y-5">
      ...
      <div className="flex justify-between items-end">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={handleClickModify} disabled={saving} className="px-5 py-2.5 text-sm font-semibold text-white bg-gray-900 rounded-lg hover:bg-gray-800 disabled:opacity-50 transition-colors">
            {saving ? '저장 중...' : '저장'}
          </button>
        </div>
      </div>
