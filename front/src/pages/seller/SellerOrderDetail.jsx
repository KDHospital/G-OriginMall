...
export default function SellerOrderDetail() {
    ...
    const handleUpdateStatus = () => {
        ...
        axiosInstance.patch(`/seller/orders/${orderId}/status?status=${nextStatus}`)
            .then(() => {
    ...
    const handleCancelItem = (orderItemId) => {
        ...
        axiosInstance.patch(`/seller/orders/${orderId}/items/${orderItemId}/cancel`)
            .then(() => {
                alert("상품이 취소되었습니다.");
                fetchOrder();
            })
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {canUpdateStatus && (
                                <button
                                    ...
                                    className="text-xs px-3 py-1.5 bg-green-700 text-white rounded hover:bg-green-600 transition-colors whitespace-nowrap"
                                >
