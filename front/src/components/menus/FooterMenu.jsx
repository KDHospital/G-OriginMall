                    ...
                    <div className="flex justify-between mb-16">
                        <div className="">
                            ...
                            <div className="flex gap-4 items-center">
                                <Link to={"/"} className="w-10 h-10 rounded-full bg-slate-200 dark:bg-slate-800 flex items-center justify-center hover:bg-primary hover:text-white transition-colors" href="#">
                            ...
                            {/* G-Origin-mall 정보 */}
                            <div className="border-slate-200 dark:border-slate-800 pt-10 text-xs text-slate-400">
